%% ReadInput function
function [ndime,nnode,nelem,nelnd,npres,ntrac,mate,coor,conn,pres,trac] = ReadInput_hypo(infile)
    ...
    mate(13) =  str2double(cellarray{1}{30}); % nstpho
    mate(14) =  str2double(cellarray{1}{32}); % nprtho
