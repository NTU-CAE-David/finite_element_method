function [strain_matrix, stress_matrix] = ElemStrain_hypo(ndime,nnode,nelem,nelnd,coor,conn, mate, u)
    ...
    for iel = 1:nelem
        ...
        for im = 1:M
            ...
            for i = 1:ndime
                for j = 1:ndime
                    ind = switchInd2(i, j); 
                    strain_gauss_matrix(iel, ind, im) = epsi(i,j);
                    stress_gauss_matrix(iel, ind, im) = sigm(i,j);
                end
            end
