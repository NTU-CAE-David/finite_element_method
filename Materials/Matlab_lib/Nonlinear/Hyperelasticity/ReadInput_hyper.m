%% ReadInput function
function [ndime,nnode,nelem,nelnd,npres,ntrac,mate,coor,conn,pres,trac] = ReadInput_hyper(infile)
    ...
    mate(10) =  str2double(cellarray{1}{24}); % s0
    mate(11) =  str2double(cellarray{1}{26}); % e0
    mate(12) =  str2double(cellarray{1}{28}); % nho
    mate(13) =  str2double(cellarray{1}{30}); % nstphe
    mate(14) =  str2double(cellarray{1}{32}); % nprthe
    mate(15) =  str2double(cellarray{1}{34}); % mu1
    mate(16) =  str2double(cellarray{1}{36}); % K1
