...
Point(1) = {0, 0, 0, sizeX/numDivisions};
Point(2) = {sizeX, 0, 0, sizeX/numDivisions};
Point(3) = {sizeX, sizeY, 0, sizeX/numDivisions};
Point(4) = {0, sizeY, 0, sizeX/numDivisions};
Point(5) = {0, 0, sizeZ, sizeX/numDivisions_Z};
Point(6) = {sizeX, 0, sizeZ, sizeX/numDivisions_Z};
Point(7) = {sizeX, sizeY, sizeZ, sizeX/numDivisions_Z};
Point(8) = {0, sizeY, sizeZ, sizeX/numDivisions_Z};
