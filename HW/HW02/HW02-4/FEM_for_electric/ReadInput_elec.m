%% ReadInput function
function [ndime,nnode,nelem,nelnd,npres,ntrac,mate,coor,conn,pres,trac] = ReadInput_elec(infile)
    ...
    % 讀取MATPROP
    mate = zeros(3,1);
    mate(1) = str2num(cellarray{1}{6}); % material-conductiviry
    mate(2) = str2num(cellarray{1}{8}); % resistance
    mate(3) = str2num(cellarray{1}{10}); % poisson's-ratio
